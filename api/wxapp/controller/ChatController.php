...
class ChatController extends AuthController
{
    ...
    public $uni_appid         = '__UNI__B467BDC';
    public $requestAuthSecret = 'BIc05zkCBPUIrLU4GF+9rA==';
    public $baseIDUrl         = 'https://fc-mp-32ebff6a-cad4-4bb5-a6e3-c34e169705d2.next.bspapp.com/shengyuncocreation';
     ...
     * )
     *
     *  https://xcxkf193.aubye.com/api/wxapp/chat/get_uid?token=72795924cc8484d4d9ad4eca1c221d95b384a279526c35ae54bed453764ab949
     *
     */
    public function get_uid()
    {
        ...
        if (isset($res['errCode']) && $res['errCode'] === 0) {
            ...
            if ($this->user_info['identity_type'] == 'member') $MemberModel::where(['id' => $this->user_id])->save($update);
            if ($this->user_info['identity_type'] == 'matchmaker') $MemberMatchmakerModel::where(['id' => $this->user_id])->save($update);

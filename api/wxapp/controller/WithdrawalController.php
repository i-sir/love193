...
class WithdrawalController extends AuthController
{
     ...
     * )
     *
     *   test_environment: http://love193.ikun:9090/api/wxapp/withdrawal/find_withdrawal_list
     *   official_environment: https://xcxkf193.aubye.com/api/wxapp/withdrawal/find_withdrawal_list
     ...
     * )
     *
     *   test_environment: http://love193.ikun:9090/api/wxapp/withdrawal/add_withdrawal
     *   official_environment: https://xcxkf193.aubye.com/api/wxapp/withdrawal/add_withdrawal
    ...
    public function add_withdrawal()
    {
        ...
        if ($result) {
            ...
            $MemberRecommendModel->dec_balance($this->user_id, $recharge['price'], '用户提现', $remark, 0, $recharge['order_num']);
            // 提交事务
            Db::commit();
